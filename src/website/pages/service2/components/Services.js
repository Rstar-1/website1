  ...
  return (
    <div className="ptpx60 pbpx60">
      <div className="container mx-auto">
        ...
        <div className="grid-cols-3 gap-12 mtpx50">
          <div className="prpx20 plpx20 mtpx10 mbpx20">
            ...
            <div className="text-center">
              <h4 className="textprimary fsize24 mtpx17 mbpx1">
                Business Services
              </h4>
              <p className="textgray fsize17 mtpx10">
